    ...
    <section className="flex flex-row gap-16 mt-10 p-4">
      <div className='flex-1 grid grid-rows-2 gap-12 ps-8'>
        <div className='grid grid-cols-2 gap-8'>
          <button className='grid grid-cols-3 items-center rounded-lg bg-[#134558] px-4 py-5 hover:bg-[#134558] hover:scale-105 transition-all duration-300'>
          ...
          <button className='rounded-lg bg-[#134558] px-4 py-5 hover:bg-[#134558] hover:scale-105 transition-all duration-300'>
            <div className='flex items-center justify-center'>
