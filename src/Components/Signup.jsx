...
const Signup = () => {
  ...
  const [password, setPassword] = useState("");
    return (
    <>
    <div className="w-full flex items-stretch justify-center overflow-hidden shadow-md">
    ...
    <div>
      <form className="flex flex-col items-center justify-between gap-2 w-80 p-6 bg-slate-white">
